...
class DuoPokemon extends React.Component {
  render(){
    ...
    return (
        <tr>
          ...
          <TableCell><a href={this.props.link}>{this.props.trainer1}<br/>{this.props.trainer2}</a></TableCell>
        </tr>
    )
  }
}

export default DuoPokemon;
